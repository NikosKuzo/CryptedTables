...
<html lang="ru">
  <head>
    ...
    <title>Смотробитва</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<?php require "./register&authorization/db.php"; // подключаем файл для соединения с БД?>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="register&authorization/lk.php">Личный кабинет</a></li>
