...
<button type="button" id="funcButton" class="btn btn-outline-secondary" onclick="createButtons('Часы, time(), Дата, date(), Стеганография, steg(), Шифрование стороняя библиотека, lab3(), Многоалфавитная подстановка, lab2()')" name="delete_user">Модульные функции</button>
